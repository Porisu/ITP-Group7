...
In order to be able to access the project, you must first install all the required software in the txt file, and install 2 AI Models from Huggingface.
...
Next, create a folder called 'models' and download these 2 models from Huggingface and place them in the models folder
...
## 2. Prompt Template
In the chromaDB, there is a json file called prompt_template.json that allows the AI to respond with predefined queries, the format of it is "question:response"
